/* discord-interactions-bot/src/data/data.ts */
...
export const commandArray = [
  ...
  { // 15
    name: "level",
    description: `Displays your (by default) or the mentioned user's level. (${COMMAND_PREFIX})`
  },
  { // 16
    name: "topranks",
